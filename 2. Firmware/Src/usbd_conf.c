...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  hpcd_USB_OTG_HS.Init.use_dedicated_ep1 = DISABLE;//ENABLE;
...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
  //MAX 4KBytes/1KWords || 0x1000Bytes/0x400Words
	HAL_PCDEx_SetRxFiFo(&hpcd_USB_OTG_HS, 0x220);//SHARE OUT   speaker / ctrl    [0x1E0 words]/[0x40 words] //384B * 5 PACKET
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 0, 0x40); //IN 0     ctrl              [0x40 words]
	HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 1, 0x10); //IN 1     unused		         [0x10 words]
	HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 2, 0x10); //IN 2     feedback          [0x10 words]
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_HS, 3, 0x180);//IN 3     micphone          [0x180 words]//384B * 4 PACKET
  }
  return USBD_OK;
}
